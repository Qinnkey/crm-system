					...
					<el-row>           			
            			...
            			<el-col :span="9">
							<el-form-item label="开发时间起：" prop = "devdatebegin">
								<el-date-picker type="date" :disabled="true" placeholder="选择日期" v-model="ruleForm1.devdatebegin"  style="width: 100%;"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="开发时间止：" prop = "devdateend">
								<el-date-picker type="date" :disabled="true" placeholder="选择日期" v-model="ruleForm1.devdateend" style="width: 100%;" ></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="开发状态：">
								<el-select v-model="ruleForm1.devstatus" :disabled="true" placeholder="请选择">
						...
						<el-col :span="9">
							<el-form-item label="交付状态：">
								<el-select v-model="ruleForm1.delystatus" :disabled="true" placeholder="请选择">
						...
						<el-col :span="9">
							<el-form-item label="创建时间：">
								<el-date-picker type="date" :disabled="true" placeholder="选择日期" v-model="ruleForm1.createdate" style="width: 100%;" :picker-options="pickerOptions"></el-date-picker>
							</el-form-item>
						</el-col>
						<el-col :span="18">
						...
						<el-col :span="4":offset="9">
							<router-link to="/item_develop_list"><el-button style="margin-bottom: 40px;">返回</el-button></router-link>
						</el-col>
					</el-row>
				</el-form>
			</div>
		...
		methods: {
			...
			loadData() {
				this.$http.get('/list/itemDevelop/list', {
					...
					switch (json.devstatus){
						case 1:this.ruleForm1.devstatus = '1';
							break;
						case 2:this.ruleForm1.devstatus = '2';
							break;
						case 3:this.ruleForm1.devstatus = '3';
							break;
						case 4:this.ruleForm1.devstatus = '4';
							break;
						default:this.ruleForm1.devstatus = '';
							break;
					}
					switch (json.delystatus){
						case 1:this.ruleForm1.delystatus = '1';
							break;
						case 2:this.ruleForm1.delystatus = '2';
							break;
						default:this.ruleForm1.devstatus = '';
							break;
					}
					this.ruleForm1.devdatebegin = json.devdatebegin;
					this.ruleForm1.devdateend = json.devdateend;
					this.ruleForm1.createdate = json.createdate;
				})
				this.itemData();
			},
			// 加载文档和需求
				...
				this.$http.get("/list/itemDevelop/itemDocs",{
					params: {
	          		...
	          		if (res.body.code == 100 && json.file.length > 0){
						...
						console.log("detail=================" + this.ruleForm1.zips)
	          		}
				})
			},
			...
			submitForm1(formName) {
					this.$refs[formName].validate((valid) => {
						if(valid) {
							this.$http.post('/list/itemDevelop/update',{
								token: localStorage.CRM_token,
...
<style type="text/css">
	.detail_itemDevelop .table_list .el-upload-list__item .el-icon-close{display: none;} 
	.detail_itemDevelop .table_list .el-form-item__content .upload-demo .el-upload{display: none;}
</style>
