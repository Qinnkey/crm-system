					...
					<el-row>
						...
						<el-col :span="9">
							<el-form-item label="公司名称：" prop="bigcompanyname">
								<el-input type="text" v-model="ruleForm.bigcompanyname" auto-complete="off" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="9">
...
<script>
	...
	export default {
		...
		methods: {
			...
			submitForm(formName) {
				...
				this.$refs[formName].validate((valid) => {
					if(valid) {
						//提交对应的内容
						this.$http.post("/list/bigcustomer/update",{
									token: localStorage.CRM_token,
									bigid     : this.bigid,
      ...
      limititem(val) {
        ...
        if (newVal[2].childList[0].map.updateFun == 0) {
