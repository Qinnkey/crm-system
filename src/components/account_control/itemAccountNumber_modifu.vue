					...
					<el-row>
						<el-col :span="9">
							<el-form-item label="帐号：" prop="username">
								<el-input type="tel" v-model="ruleForm1.username" auto-complete="off"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="密码：" prop="password">
								<el-input type="text" v-model="ruleForm1.password" auto-complete="off"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="网址：">
								<el-input type="text" v-model.number="ruleForm1.url"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="其他：">
								<el-input type="textarea" v-model="ruleForm1.comments"></el-input>
							</el-form-item>
						</el-col>
