			...
			<div class="user_info">
				<el-form :model="ruleForm1" :rules="rules" ref="ruleForm1" label-width="200px" class="demo-ruleForm">
					...
					<el-col :span="9">
						...
						<el-col :span="24" >
							<el-form-item label-width="100px">
								<el-button type="success" v-if="limitCtrl.renreTraceSubmit==1" @click="submitForm1('ruleForm1')">提交</el-button>
		...
		methods: {
					...
					this.$refs[formName].validate((valid) => {
						...
						if(valid) {
							...
							this.$http.post("/list/itemRenew/save", {
								...
								itemtypedetail: this.ruleForm1.custitemtype == 7? this.ruleForm1.itemtypedetail:0,//汇搜云小程序类型						
			...
			handleSelectToReplaced(item) {
		      ...
		      limititem(val) {
		        ...
		        if (newVal[7].childList[0].map.renreTraceAdd == 0) {
