				...
				<el-form ref="form" :inline="true" :model="form" label-width="80px">
					<el-row>
						...
						<el-form-item label-width="80px">
							...
							<el-button type="info" icon="delete" @click="signitem">移除已处理项目</el-button>
						</el-form-item>
					</el-row>
				</el-form>
				<!--表格块-->
...
<script>
	...
	export default {
		...
		created: function() {
			...
			console.log("begin==",this.form.begindate,"==this.begindate==",this.begindate1);
		...
		methods: {
			...
			limititem(val){
				...
				if(newVal[0].childList[5].childstatus == 0) {
