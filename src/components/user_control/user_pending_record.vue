						...
						<el-collapse v-model="activeNames" style="margin: 10px 0;">
							<el-collapse-item title="回访记录" name="1">
								<el-table :data="tableData1" style="width: 100%">
									<el-table-column prop="contact" label="客户姓名" width="200"></el-table-column>
									...
									<el-table-column prop="createdate" label="服务时间"></el-table-column>
...
<script>
	...
	export default {
		...
		methods: {
			...
			returnPage(){
					this.$router.push({path: "/user_pending_list"})
			},
			//提交
			submitForm(){
