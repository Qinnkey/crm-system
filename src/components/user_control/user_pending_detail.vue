			...
			<div class="table_list">
				...
				<el-row>
					...
					<el-col :span="4":offset="9">
						<router-link to="/user_pending_list"><el-button style="margin-bottom: 40px;">返回</el-button></router-link>
					</el-col>
				</el-row>
			</div>
		</main_component>
			...
			loadData(){
				this.$http.get("/list/customer/detailedInfo",{
					...
					if(res.body.code==100 && res.body.data!=null){
						...
						this.user_detail.userInfo[9].modelVal=datas.itemname;
						this.user_detail.userInfo[10].modelVal=datas.contnum;
