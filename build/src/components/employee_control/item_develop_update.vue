				...
				this.$http.get("/list/itemDevelop/itemDocs",{
					params: {
	          		...
	          		if (res.body.code == 100 && json.file.length > 0){
						...
						console.log("update=================" + this.ruleForm1.zips)
	          		}
				})
			},
...
<style type="text/css">
	.update_itemDevelop .table_list .el-upload-list__item .el-icon-close{display: none;} 
	.update_itemDevelop .table_list .el-form-item__content .upload-demo .el-upload{display: none;}
</style>
