					...
					<el-row>
						<el-col :span="9">
							<el-form-item label="项目名称: " prop="itemname">
								<el-autocomplete style="width: 100%;" class="inline-input" v-model="ruleForm1.itemname" :fetch-suggestions="querySearch" placeholder="请输入项目名称" @select="handleSelect"></el-autocomplete>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="责任人：" prop="responsible">
								<el-autocomplete style="width: 100%;" class="inline-input" v-model="ruleForm1.responsible" :fetch-suggestions="querySearch1" placeholder="请选择责任人名字" @select="handleSelect1"></el-autocomplete>
							</el-form-item>
						</el-col>
						<el-col :span="9">
							<el-form-item label="小组负责人：" prop="groupresponsible">
								<el-autocomplete style="width: 100%;" class="inline-input" v-model="ruleForm1.groupresponsible" :fetch-suggestions="querySearch2" placeholder="请选择小组负责人名字" @select="handleSelect2"></el-autocomplete>
							</el-form-item>
						</el-col>
						<el-col :span="9">
						...
						<el-col :span="9">
							<el-form-item label="是否解决：">
								<el-select v-model="ruleForm1.solve" placeholder="请选择">
						...
						<el-col :span="18">
							<el-form-item label="文档：" label-width="150px">
								<el-upload class="upload-demo" :on-success="handlesuccess1" :before-upload="beforeAvatarUpload1" action="/list/accident/uploaddoc" :file-list="this.ruleForm1.zips" :data="token" :on-preview="handlePreview" :on-remove="handleRemove1">
		...
		methods: {
			...
			loadData() {
				this.$http.get('/list/accident/list', {
					...
					this.groupresid = json.groupresid;
			...
			handleSelect1(item) {
				console.log(this.ruleForm1.responsible)
					...
					this.$refs[formName].validate((valid) => {
						if(valid) {
							...
							this.$http.post('/list/accident/update', {
								...
								solve: this.ruleForm1.solve == '' ? '0' : this.ruleForm1.solve,
								department: this.oid,
