			...
			<div class="table_list">
				...
				<el-row>
					...
					<el-col :span="4":offset="9">
						<router-link to="/continue_fee"><el-button style="margin-bottom: 40px;">返回</el-button></router-link>
					</el-col>
				</el-row>
			</div>
		</main_component>
			...
			loadData(){
				this.$http.get("/list/customer/detailedInfo",{
					...
					if(res.body.code==100 && res.body.data!=null){
						...
						this.user_detail.userInfo[7].modelVal=datas.salename;
						this.user_detail.userInfo[8].modelVal=datas.itemtypename;
						this.user_detail.userInfo[9].modelVal=datas.itemdetailname;
						this.user_detail.userInfo[10].modelVal=datas.itemname;
						this.user_detail.userInfo[11].modelVal=datas.contnum;
						this.user_detail.userInfo[12].modelVal=datas.idcard;
						this.user_detail.userInfo[13].modelVal=datas.itembegindate?this.changeTime(datas.itembegindate):"";
						this.user_detail.userInfo[14].modelVal=datas.itemenddate?this.changeTime(datas.itemenddate):"";
						this.user_detail.userInfo[15].modelVal=datas.custstatusName;
						this.user_detail.userInfo[16].modelVal=datas.evaluate;
