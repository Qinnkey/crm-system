			...
			<div class="table_list">
				...
				<el-row>
					...
					<el-col :span="4":offset="9">
						<router-link to="/customer_change"><el-button style="margin-bottom: 40px;">返回</el-button></router-link>
					</el-col>
				</el-row>
			</div>
		</main_component>
			...
			loadData(){
				this.$http.get("/list/customer/detailedInfo",{
					...
					if(res.body.code==100 && res.body.data!=null){
						...
						this.user_detail.userInfo[11].modelVal=datas.idcard;
						this.user_detail.userInfo[12].modelVal=datas.itembegindate?this.changeTime(datas.itembegindate):"";
						this.user_detail.userInfo[13].modelVal=datas.itemenddate?this.changeTime(datas.itemenddate):"";
						this.user_detail.userInfo[14].modelVal=datas.custstatusName;
						this.user_detail.userInfo[15].modelVal=datas.evaluate;
