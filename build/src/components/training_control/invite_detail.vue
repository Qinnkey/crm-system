						...
						<el-collapse v-model="activeNames" style="margin: 10px 0;">
							<el-collapse-item title="新增项目记录" name="1">
								<el-table :data="tableData1" style="width: 100%">
									...
									<el-table-column prop="coursename" label="相关课程" width="150"></el-table-column>
									<el-table-column prop="courseaddress" label="课程地点" width="150"></el-table-column>
...
<script>
	...
	export default {
      ...
      limititem(val) {
        ...
        if (newVal[8].childList[1].map.visitHisFun == 0) {
