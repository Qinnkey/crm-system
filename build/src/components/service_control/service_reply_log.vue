				...
				<el-form ref="record_detail" label-width="100px" class="demo-ruleForm">
					<div class="record_list" >
						...
						<el-col :span="9">
							...
							<el-col :span="10" >
								<el-form-item label="业务员回复：">
									 <el-checkbox v-model="replybox"></el-checkbox>
								</el-form-item>
							</el-col>
						</el-row>
					</div>
						...
						<el-collapse v-model="activeNames" style="margin: 10px 0;">
							<el-collapse-item title="回访记录" name="1">
								<el-table :data="tableData1" style="width: 100%">
									<el-table-column prop="contact" label="客户姓名" width="100"></el-table-column>
									<el-table-column prop="salename" label="业务员" width="80"></el-table-column>
									<el-table-column prop="visitwayname" label="服务方式" width="95"></el-table-column>
									<el-table-column prop="createdate" label="服务时间" width="95"></el-table-column>
									<el-table-column prop="petname" label="回访人" width="80"></el-table-column>
									<el-table-column prop="visitremarks" label="回访备注"></el-table-column>
									<el-table-column prop="replystatusname"  label="是否需业务员回复" width="100"></el-table-column>
									<el-table-column prop="replycontext"  label="业务员回复内容"></el-table-column>
								</el-table>
							</el-collapse-item>
						</el-collapse>
					</el-col>
...
<script>
	...
	export default {
		...
		created: function() {
			...
			this.loadData();
			this.loadList();
			console.log(this.itemidtwo,"====end==========");
      ...
      limititem(val) {
        ...
        if (newVal[6].childList[1].map.visitHisFun == 0) {
