					...
					<el-row>
						...
						<el-col :span="9">
							<el-form-item label="密码：">
								<el-input type="text" v-model.number="ruleForm1.password"></el-input>
							</el-form-item>
						</el-col>
	...
	export default {
		...
		data() {
			...
			return {
				...
				ruleForm1: {
					phone     :this.$route.query.phone,				//用户名
					password    : '',				//密码
				 },
			}
		},
		...
		methods: {
			...
			submitForm1(formName) {
				this.$refs[formName].validate((valid) => {
					if(valid) {
						this.$http.post('/list/customerUser/add',{
